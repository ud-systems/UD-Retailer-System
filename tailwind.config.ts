		...
		extend: {
			...
			colors: {
				...
				'theme': {
					...
					inactive: 'var(--theme-inactive)',
				},
				'status': {
					active: 'var(--status-active)',
					inactive: 'var(--status-inactive)',
				},
				// Removed hardcoded color palettes - only dynamic theme colors are used
				// ThemeService will inject all theme colors dynamically via CSS variables
			},
			borderRadius: {
				lg: 'var(--radius)',
